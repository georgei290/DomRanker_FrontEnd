          ...
          <TopHolder2>
            <Section>
              ...
              <Detail>
                ...
                <InnerDetail>
                  <SmallText>redirects</SmallText>
                  <Numb>17</Numb>
                  <SmallBar />
                </InnerDetail>
                <InnerDetail>
                  <SmallText>canonical</SmallText>
                  <Numb>22</Numb>
                  <SmallBar />
                </InnerDetail>
              </Detail>
            ...
            <Section>
              ...
              <Detail>
                <InnerDetail>
                  <SmallText>noopener</SmallText>
                  <Numb>28</Numb>
                  <SmallBar />
                </InnerDetail>
                <InnerDetail>
                  <SmallText>noreferrer</SmallText>
                  <Numb>17</Numb>
                  <SmallBar />
                </InnerDetail>
                <InnerDetail>
                  <SmallText>external</SmallText>
                  <Numb>22</Numb>
                  <SmallBar />
                </InnerDetail>
              </Detail>
